...
names(Conc2014)<-c("ENTIDAD","FOLIOVIV","FOLIOHOG","GASTO","TOT_INTEG","INGCOR","INGTRAB","TRABAJO","NEGOCIO",
...
mydesign <- svydesign(id=~UPM,strata=~EST_DIS,data=Conc2014,weights=~FACTOR)
