...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH_2014/ENIGH_2014/")
...
Poblacion<-read.dbf("ncv_poblacion_2014_concil_2010_dbf.dbf",as.is = T)
...
Deflactores2014<-data.frame(entidad,entidades,Deflactores)

Conc<-merge(Conc,Deflactores2014,by=c("entidad"))
...
write.dbf(Conc,file="Conc_2014.dbf")
...
#reading the data
setwd("C:/Users/Erick/Dropbox/GIC/GITHUB2018/GIC/ENIGH_2014/ENIGH_2014/")
Conc2014<-read.dbf("Conc_2014.dbf",as.is = T)



names(Conc2014)<-toupper(names(Conc2014))
...
names(c_DECIL_ES)=c("ING COR2014", "TRABAJO2014", "SUBORDINADO2014", "NEGOCIOS2014","OTROS TRAB2014", "RENTAS2014","UTILIDAD2014", "ARRENDA2014", "TRANSFER2014","JUBILACION2014", "BECAS2014", "DONATIVOS2014", "REMESAS2014", "BENEGOBIERNO2014", "TRANS HOG2014", "TRANS INST2014", "ESTIM ALQU2014", "OTROS INGRESOS2014")

names(c_DECIL_SE)=c("ING COR2014", "TRABAJO2014", "SUBORDINADO2014", "NEGOCIOS2014","OTROS TRAB2014", "RENTAS2014","UTILIDAD2014", "ARRENDA2014", "TRANSFER2014","JUBILACION2014", "BECAS2014", "DONATIVOS2014", "REMESAS2014", "BENEGOBIERNO2014", "TRANS HOG2014", "TRANS INST2014", "ESTIM ALQU2014", "OTROS INGRESOS2014")

names(c_DECIL_CV)=c("ING COR2014", "TRABAJO2014", "SUBORDINADO2014", "NEGOCIOS2014","OTROS TRAB2014", "RENTAS2014","UTILIDAD2014", "ARRENDA2014", "TRANSFER2014","JUBILACION2014", "BECAS2014", "DONATIVOS2014", "REMESAS2014", "BENEGOBIERNO2014", "TRANS HOG2014", "TRANS INST2014", "ESTIM ALQU2014", "OTROS INGRESOS2014")

names(c_DECIL_LI)=c("ING COR2014", "TRABAJO2014", "SUBORDINADO2014", "NEGOCIOS2014","OTROS TRAB2014", "RENTAS2014","UTILIDAD2014", "ARRENDA2014", "TRANSFER2014","JUBILACION2014", "BECAS2014", "DONATIVOS2014", "REMESAS2014", "BENEGOBIERNO2014", "TRANS HOG2014", "TRANS INST2014", "ESTIM ALQU2014", "OTROS INGRESOS2014")
...
prueba<-c_DECIL_ES%>%
  mutate(`ING COR2014`=`ING COR2014`, prueba=TRABAJO2014+RENTAS2014+JUBILACION2014+BECAS2014+DONATIVOS2014+REMESAS2014+BENEGOBIERNO2014+`TRANS HOG2014`+`TRANS INST2014`+`ESTIM ALQU2014`+`OTROS INGRESOS2014`)

all.equal(prueba$`ING COR2014`,prueba$prueba)
...
write.dbf(Consumo,file = "Nacional Consumo  por DECIL 2014.dbf")
write.dbf(Consumo_SE,file="Nacional Consumo  por DECIL 2014 SE.dbf")
write.dbf(c_DECIL_ES,file = "Nacional por fuente por DECIL estimaciones 2014.dbf")
write.dbf(c_DECIL_SE,file = "Nacional por fuente por DECIL errores standard 2014.dbf")
write.dbf(c_DECIL_CV,file = "Nacional por fuente por DECIL CV 2014.dbf")
write.dbf(c_DECIL_LI,file = "Nacional por fuente por DECIL LI 2014.dbf")
write.dbf(c_DECIL_ES,file = "Nacional por fuente por DECIL LS 2014.dbf")
...
names(Conc2014)<-c("ENTIDAD","FOLIOVIV","FOLIOHOG","GASTO","TOT_INTEG","ING_COR","INGTRAB","TRABAJO","NEGOCIO",
...
write.dbf(bottom_por_ingresos,file = "bottom_por_ingresos_2014.dbf")
...
write.dbf(Consumo,file = "Consumo_por_bottom_2014.dbf")
